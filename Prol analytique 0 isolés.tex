...
\item $A$ est une partie discrète et fermée de $U$.
\end{enumerate}
...
$(iii) \Rightarrow (i)$ Prenons $z \in U$, si $z \in A$ alors il existe un voisinage $V$ de $z$ tel que $V \cap A = \set{z}$ car $A$
...
\[ \abs{f(z)} \geq \abs{z-u}^k ( \abs{a_k} - \abs{g(z)} > 0 . \]
